...
#string to test
doc_new = ['obama is running for president in 2018']
...
#first we will use n-grams techniques
...
forest model with n-gram has better accuracy than with the parameter estimated. The logistic regression model with best parameter 
has almost similar performance as n-gram model so logistic regression will be our choice of model for prediction.
"""
